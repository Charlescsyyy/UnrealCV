...
public:
	...
	void AnnotateMeshComponents(UWorld* World);
	void AnnotateByParent(UWorld* World);
	enum class ESegmentationMode
    {
        Part,
        Object
    };
	void SetSegmentationMode(ESegmentationMode Mode, UWorld* World);
	//2025-7-23 end
...
private:
	...
	//2025-7-23 part segmentation logic-Siyi Chen
	ESegmentationMode GetCurrentSegmentationMode() const { return CurrentSegmentationMode; }
	ESegmentationMode CurrentSegmentationMode = ESegmentationMode::Object;
};
