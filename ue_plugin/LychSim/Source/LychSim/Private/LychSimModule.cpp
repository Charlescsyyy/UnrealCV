...
class FLychSimModule : public IModuleInterface
{
	virtual void StartupModule() override;
	virtual void ShutdownModule() override;
};

IMPLEMENT_MODULE(FLychSimModule, LychSim)

void FLychSimModule::StartupModule()
{
...
void FLychSimModule::ShutdownModule()
{
}
