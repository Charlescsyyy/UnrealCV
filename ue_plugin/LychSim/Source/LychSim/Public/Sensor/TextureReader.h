...
LYCHSIM_API bool FastReadTexture2DAsync(FTextureRHIRef Texture2D, TFunction<void(FColor*, int32, int32)> Callback);

/** Read texture from UE4 and resize to expected size */
// LYCHSIM_API bool ResizeFastReadTexture2DAsync(FTextureRHIRef Texture2D, int TargetWidth, int TargetHeight, TFunction<void(FColor*, int32, int32)> Callback);
